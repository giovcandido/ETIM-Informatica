<?php  
	...
	$msg_contato = "INSERT INTO mensagens(nome, email, mensagem) VALUES ('$nome', '$email', '$mensagem')";
...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<aside id="aside_contato">
        <p class="titulo_contato">Agradecemos seu Contato!</p>
        <p class="texto_contato">Mensagem enviada com sucesso!</p>
    </aside>
